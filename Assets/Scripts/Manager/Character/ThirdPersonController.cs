...
namespace PlayerControl
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private float _LastIdleIndex = 0.0f;
        private float _CurrentIdleIndex = 0.5f;
        ...
        private void Move()
        {
            ...
            if (_idleTimeoutDelta <= 0.0f)
            {
                ...
                //Debug.Log("rand number=" + t.ToString());
                if (Math.Abs(t - _LastIdleIndex) < 0.4)
                    _CurrentIdleIndex = 0.5f;
                else
                    _CurrentIdleIndex = t;
                _idleTimeoutDelta = IdleTimeout;
            }
